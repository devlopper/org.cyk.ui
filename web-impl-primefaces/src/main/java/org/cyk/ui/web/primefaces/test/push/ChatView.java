...
public class ChatView implements Serializable {
	...
	private static final long serialVersionUID = 4936496183699762148L;
    ...
    private final static String CHANNEL = "/"+UIManager.PUSH_NOTIFICATION_CHANNEL+"/";
    ...
    public void sendGlobal() {
    	...
    	eventBus.publish(CHANNEL + "*", new FacesMessage(username + ": " + globalMessage)); 
        globalMessage = null;
    }
    ...
    public void login() {
        ...
        if(users.contains(username)) {
            ...
            users.add(username);
            PrimefacesManager.getInstance().connectSocket("subscriber", "/"+username);

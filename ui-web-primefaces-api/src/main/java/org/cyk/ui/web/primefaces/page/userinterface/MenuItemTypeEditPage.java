...
public class MenuItemTypeEditPage extends AbstractDataTreeNodeEditPage<MenuItemType> implements Serializable {

	private static final long serialVersionUID = 3274187086682750183L;	
	
	@Getter @Setter 
	@FieldOverrides(value = {
			@FieldOverride(name=AbstractDataTreeForm.FIELD_PARENT,type=MenuItemType.class)
			})
	public static class Form extends AbstractDataTreeTypeForm<MenuItemType> {

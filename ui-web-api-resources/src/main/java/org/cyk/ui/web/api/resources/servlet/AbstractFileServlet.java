...
public abstract class AbstractFileServlet extends HttpServlet implements Serializable {
	...
	protected void doGet(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
		System.out.println("AbstractFileServlet.doGet() : "+RequestHelper.getInstance().getParameterAsString("identifier")+" : "+request.getParameterMap());
		/*
		initialisation(request, response);
		Collection<FileHelper.File> files = getFiles(request, response);

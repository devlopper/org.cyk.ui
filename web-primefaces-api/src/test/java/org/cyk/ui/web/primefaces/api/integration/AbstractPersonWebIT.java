...
public abstract class AbstractPersonWebIT extends AbstractIntegrationWebTest {
	...
	protected void waitForClickOn(WebDriver webDriver,String xpath,Long timeOutInSecond){
	...
	protected void __execute__(WebDriver webDriver) {
        ...
        fillForm(webDriver,Boolean.FALSE,"pers0011","yao","evelyne",file1.getPath());        
        ...
        fillForm(webDriver,Boolean.TRUE,"PA021","Zouzou","Ange",file2.getPath());
        submitForm(webDriver);
        pause(3 * 1000l);

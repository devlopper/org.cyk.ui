...
public class ConsultActorPage extends AbstractConsultPage<AbstractActor> implements Serializable {
	...
	@Getter @Setter
	public static class MainDetails extends AbstractOutputDetails implements Serializable {
	...
	@Getter @Setter
	public static class MedicalDetails extends AbstractOutputDetails implements Serializable {
		private static final long serialVersionUID = -1498269103849317057L;
	...
	@Getter @Setter
	public static class ContactDetails extends AbstractOutputDetails implements Serializable {
		private static final long serialVersionUID = -1498269103849317057L;
	...
	@Getter @Setter
	public static class JobDetails extends AbstractOutputDetails implements Serializable {
		private static final long serialVersionUID = -1498269103849317057L;
	...
	@Getter @Setter
	public static class OtherDetails extends AbstractOutputDetails implements Serializable {
		private static final long serialVersionUID = -1498269103849317057L;

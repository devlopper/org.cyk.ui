...
public class PrimefacesResourcesManager extends AbstractBean implements Serializable {
	...
	static {
		...
		Properties.setDefaultValue(NotificationDialog.class, Properties.TEMPLATE, "/org.cyk.ui.web.primefaces/template/decorate/panel/dialog/dialog.xhtml");
		Properties.setDefaultValue(NotificationDialog.class, Properties.INCLUDE, "/org.cyk.ui.web.primefaces/include/panel/dialog/notifications.xhtml");
		...
		Properties.setDefaultValue(Notifications.class, Properties.TEMPLATE, "/org.cyk.ui.web.primefaces/template/decorate/message/messages.xhtml");
		Properties.setDefaultValue(Notifications.class, Properties.INCLUDE, "/org.cyk.ui.web.primefaces/include/dummyemptycontent.xhtml");
		...
		Properties.setDefaultValue(Request.class, Properties.TEMPLATE, "/org.cyk.ui.web.primefaces/template/decorate/ajax/ajaxStatus.xhtml");
		Properties.setDefaultValue(Request.class, Properties.INCLUDE, "/org.cyk.ui.web.primefaces/include/dummyemptycontent.xhtml");
		...
		BeanListener.COLLECTION.add(new BeanAdapter(){
			...
			public void propertiesMapInstanciated(AbstractBean instance,Properties properties) {
				...
				if(instance instanceof ConfirmationDialog){
					...
					((Request)instance).getStatusDialog().getPropertiesMap().setInclude("/org.cyk.ui.web.primefaces/include/processingstatus/dialog/default.xhtml");
					...
					((Request)instance).getStatusDialog().getPropertiesMap().setHeader("REQUESR STATUS HEADER HERE...");
				}
			}
		});

...
public class InputCollectionDemoPage extends AbstractPrimefacesPage implements Serializable {
	...
	private InputCollection<Item> inputCollection2 = new InputCollection<>(Item.class);
	...
	protected void initialisation() { 
		...
		inputCollection2.getCollection().addOne(new Item().setName("Un"));
	
		inputCollection2.getCollection().addListener(new CollectionHelper.Instance.Listener.Adapter<Item>(){
			private static final long serialVersionUID = 1L;
			@Override
			public void addOne(Instance<Item> instance, Item element) {
				element.setName("voici un autre "+System.currentTimeMillis());
			}
		});

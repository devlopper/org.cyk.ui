...
@Log
public abstract class AbstractSubForm<FORM,OUTPUTLABEL,INPUT,SELECTITEM> extends AbstractBean implements UISubForm<FORM,OUTPUTLABEL,INPUT,SELECTITEM> , Serializable {
	...
	@Getter @Setter protected UIForm<FORM,OUTPUTLABEL,INPUT,SELECTITEM> container;

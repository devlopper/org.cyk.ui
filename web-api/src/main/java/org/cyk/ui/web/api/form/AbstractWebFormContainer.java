...
public abstract class AbstractWebFormContainer<FORM,OUTPUTLABEL,INPUT> extends AbstractFormContainer<FORM,OUTPUTLABEL,INPUT,SelectItem> implements IWebFormContainer<FORM,OUTPUTLABEL,INPUT> , Serializable {

...
import org.cyk.ui.api.form.AbstractSubForm;
...
public abstract class AbstractWebSubForm<FORM,OUTPUTLABEL,INPUT> extends AbstractSubForm<FORM,OUTPUTLABEL,INPUT,SelectItem> implements WebUISubForm<FORM,OUTPUTLABEL,INPUT,SelectItem> , Serializable {
	...
	public WebUIInputSelectOne<Object,FORM> inputSelectOne(UIInputSelectOne<Object,ISelectItem> anIInput) {
		...
		if(inputSelectOne.getItems()==null || inputSelectOne.getItems().isEmpty()){
			@SuppressWarnings("unchecked")
			Collection<Object> datas = (Collection<Object>) ((UIForm<?,?,?,?>)container).load(anIInput.getField().getType());

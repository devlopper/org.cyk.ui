...
public interface IWebForm<OUTPUTLABEL,INPUT,SELECTITEM> extends IForm<OUTPUTLABEL,INPUT,SELECTITEM> {
	...
	IWebInputSelectOne<Object> inputSelectOne(IInputSelectOne<Object> anIInput);

...
public abstract class AbstractWebForm<FORM,OUTPUTLABEL,INPUT> extends AbstractForm<FORM,OUTPUTLABEL,INPUT,SelectItem> implements WebUIForm<FORM,OUTPUTLABEL,INPUT> , Serializable {
